...
public class TransferFunction2DEditor extends javax.swing.JPanel {
    ...
    public void setSelectedInfo() {
        ...
        minLabel.setText(String.format("%.3f", triangleWidget.minGradient));
        maxLabel.setText(String.format("%.3f", triangleWidget.maxGradient));
    ...
    public class TriangleWidget {
        ...
        public TriangleWidget(short base, double r) {
            ...
            this.minGradient= 0;
            this.maxGradient=maxGradientMagnitude;
